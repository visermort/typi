...
class SettingsSeeder extends Seeder
{
    public function run()
    {
        ...
        $typi_settings = [
            ...
            ['id' => 10, 'group_name' => 'ru', 'key_name' => 'website_title', 'value' => 'Untitled website', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 11, 'group_name' => 'ru', 'key_name' => 'status', 'value' => '1', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 12, 'group_name' => 'config', 'key_name' => 'welcome_message', 'value' => 'Welcome to the administration panel of TypiCMS.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 13, 'group_name' => 'config', 'key_name' => 'auth_public', 'value' => 0, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 14, 'group_name' => 'config', 'key_name' => 'register', 'value' => 0, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['id' => 15, 'group_name' => 'config', 'key_name' => 'admin_locale', 'value' => 'en', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
